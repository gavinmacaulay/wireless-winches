...
The controller also sends a winch status message to the Android app and any active Monitor devices in the form of a comma separated ASCII string in the form:

`0,id,mode,v.v,s.s,r.r`

where the fields are:

.Controller status message format.
[%autowidth]
|===
