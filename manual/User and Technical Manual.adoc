...
A simple status display written in Python is provided https://github.com/gavinmacaulay/wireless-winches/blob/main/code/status_display_gui.py[here], you can write your own, or you can use some dashboard software that can parse data from a serial port (e.g., https://github.com/Serial-Studio/Serial-Studio[Serial-Studio])
