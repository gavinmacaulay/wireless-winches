...
Pin 1 in the connector should be connected to the positive of the DC supply and pin 3 to the negative of the DC supply (there is no pin 2) (see <<Schematics>> for schematics). The supplied connector can accomodate a cable with external diameter between 4 and 8 mm. 
