...
The software in the motors is changed to actively reduce the power consumption of the motor and to obtain winch status information, which is sent to the hand controller. The hand controller softare is enhanced to receive this status information and to send it out via Bluetooth.
